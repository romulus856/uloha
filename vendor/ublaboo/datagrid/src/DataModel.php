...
use Ublaboo\DataGrid\DataSource\DoctrineDBALDataSource;
...
final class DataModel
{
	...
	public function __construct($source, string $primaryKey)
	{
        ...
        } elseif ($source instanceof \Doctrine\DBAL\Query\QueryBuilder) {
            $source = new DoctrineDBALDataSource($source, $primaryKey);
